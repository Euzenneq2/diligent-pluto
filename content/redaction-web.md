  ...
  - type: features_section
    ...
    features:
      ...
      - type: feature
        ...
        content: "Le sens d’une page web est\_**déterminé en fonction des mots contenus**\_sur celle-ci. Si sur votre page, un article parle de rédaction web, il faut absolument qu'il contienne des mots clés en corrélation avec le thème tel que : netlinking, référenceur, stratégie éditoriale, digitale, optimisés, etc.\n\nEn résumé : il faut enrichir le contenu avec les mots du\_**champ**\_**lexical**\_pour atteindre les premières pages de Google.\n"
