...
sections:
  ...
  - actions: []
    grid_items:
      ...
      - title: Contenu SEO
        title_align: left
        content: >
          Un rédacteur web ne ce contente pas uniquement d'écrire pour le web,
          il doit connaitre toutes le bonne pratique pour adapter vos contenus
          aux exigences des **algorithmes des moteurs de recherche** et vous
          positionner sur les premieres pages de Google.


          Je connais la majeur partie des **techniques de référencement** SEO.
  ...
  - type: grid_section
    ...
    subtitle: "Car il est important de faire adhérer notre\_entourage professionnel\_à nos projets"
    actions:
      - type: action
        template: action
...
seo:
  ...
  title: Mary Marketing - Rédacteur web SEO - Gagnez en visibilité !
  extra:
    - name: 'og:type'
      value: website
      keyName: property
