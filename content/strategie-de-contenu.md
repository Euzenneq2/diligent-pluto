    ...
    grid_items:
      - type: grid_item
        ...
        content: >
          ...
          **profil client** typique de l'entreprise et de son domaine
          d'activité. Plus personnalisé en b2c qu'en **b2b**. Cette technique va
          ...
          Tout cela dans le but de vendre, **d'améliorer la conversion** de vos
          leads et la **fidélisation** de vos clients.
        content_align: left
        actions: []
        actions_align: left
      ...
      - type: grid_item
        ...
        content: >
          ...
          propos d'un produit, d'un service, d'un e-commerce, d'une entreprise
      ...
      - title_align: left
        ...
        content: >
          ...
          plus particulièrement sur l'une de ces **pages web**.


          En effet, votre **contenu éditorial** sera **analysé**, **étudié**,
          **décortiqué** afin de **cibler** la source de cette même perte de
          performance. Par la suite, des solutions seront trouvées puis mises en
          place afin de vous permettre de retrouver la sérénité de vos débuts.
      ...
      - title_align: left
        ...
        content: >
          ...
          **influenceurs** par exemple.
          ...
          Mettre en place une **stratégie de publication**, c'est s'assurer de
          **toucher vos cibles**.
