...
sections:
  ...
  - type: cta_section
    ...
    content: >
      **Demandez vos articles optimisés SEO, balise méta comprise pour
      0,10 €/mot**
  ...
  - content: >
      ...
      travailler son champ **lexical**, ou des méthodes de **référencement
      naturel** tel que l'**optimisation** de son contenu, le choix pertinent de
    ...
    grid_items:
      ...
      - title_align: left
        content: >
          ...
          En effet, cette technique repose sur la manière d'utiliser l'émotion
          et la confiance dans un contenu rédigé pour les visiteurs. Tout de
          même, il existe de nombreuses règles à respecter pour que votre
          copywrinting soit efficace. Avoir un **style rédactionnel** et
          **proposer du contenu de qualité** doit s'apprendre.
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
    ...
    grid_items:
      - title_align: left
        content: >
          ...
          **balises**, de trouver de nombreux nombre de **mots-clés pertinent**,
          des **requêtes** ou d'éviter le **duplicate** **content** ou le
          **spinning**, etc.
        content_align: left
        actions: []
        actions_align: left
