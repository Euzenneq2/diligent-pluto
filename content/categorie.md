  ...
  - actions: []
    grid_items:
      ...
      - title: Growth hacking
        title_align: left
        content: "Découvrez dans cette catégorie, les meilleures astuces pour notamment optimiser le\_**taux de conversion**\_de votre site internet et apprenez comment\_**générer du trafic**\_à moindre coût.\n"
        content_align: left
        actions:
          - label: Découvrir cette catégorie
        ...
        actions_align: center
        actions_width: auto
        image_alt: catégorie - growth hacking - Mary marketing
        image_position: top
        image_width: fifty
        image_align: left
        image_has_padding: false
      ...
      - title: Publicité et AdWords
        ...
        image_has_padding: false
        type: grid_item
        image: images/categorie-pub-et-ads.jpg
      ...
      - title: WordPress
        ...
        actions:
          - label: Découvrir cette catégorie
            url: /blog/categorie/wordpress-site-web/
            style: primary
            has_icon: false
            icon: arrow-left
            icon_position: right
